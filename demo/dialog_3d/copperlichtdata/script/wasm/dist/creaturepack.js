...
var Module = typeof CreatureModule !== 'undefined' ? CreatureModule : {};
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'creaturepack.wast';
  var wasmBinaryFile = 'creaturepack.wasm';
  var asmjsCodeFile = 'creaturepack.temp.asm.js';
  ...
  if (typeof Module['locateFile'] === 'function') {
    ...
    wasmTextFile = scriptDirectory + wasmTextFile;
    wasmBinaryFile = scriptDirectory + wasmBinaryFile;
    asmjsCodeFile = scriptDirectory + scriptDirectory;
  }
